base_lr = 0.004
img_size = 512 #640
random_size_range = (256, 512) #(320, 640)
DATA_ROOT = '/nas2/YJ/DATA/WHUbuilding/'  # parent folder of 'train' and 'test'
checkpoint = 'pretrained/yolox_nano_mmdet.pth' 
...
model = dict(
    ...
    neck=dict(
        ...
        use_depthwise=True),
    test_cfg=dict(nms=dict(iou_threshold=0.2, type='nms'), score_thr=0.001),  ###<-- 0.001
...
test_evaluator = dict(
    ...
    format_only=False,
    metric='bbox',
    #iou_thrs=[0.75], ###<--------------- #, 0.1 , 0.15, 0.2 , 0.25, 0.3 , 0.35, 0.4 , 0.45, 0.5 , 0.55, 0.6 , 0.65, 0.7 , 0.75, 0.8 , 0.85, 0.9 , 0.95],
    proposal_nums=(
        100, # 100
        1, # 1, 300
        10, # 10, 1000
